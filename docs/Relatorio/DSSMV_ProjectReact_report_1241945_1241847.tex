...
\includegraphics[
  ...
  height=1\textheight,
  keepaspectratio
]{images/Tests/Auth_Prints/Auth_tests_diagram.png}
\caption{Auth Tests Execution Results}
\label{fig:auth-tests}
\end{figure}
\clearpage
...
\includegraphics[
  ...
  height=1\textheight,
  keepaspectratio
]{images/Tests/CategoriasHomeScreen_Prints/CategoriasHomeScreen_diagram.png}
\caption{Categories Tests Execution Results}
\label{fig:categories-tests}
\end{figure}
\clearpage

\subsection{Lists - Tests}
\begin{figure}
\centering
\includegraphics[
  width=1\textwidth,
  height=1\textheight,
  keepaspectratio
]{images/Tests/Listas_Prints/Listas_diagram.png}
\caption{Lists Tests Execution Results}
\label{fig:lists-tests}
\end{figure}
\clearpage

\subsection{Reminders - Tests}
\begin{figure}
\centering
\includegraphics[
  width=1\textwidth,
  height=1\textheight,
  keepaspectratio
]{images/Tests/Lembretes_Prints/Lembretes1.png}
\caption{Reminders Tests Execution Results - 1/5}
\label{fig:reminders-tests}
\end{figure}
\clearpage
...
\includegraphics[
  ...
  height=1\textheight,
  keepaspectratio
]{images/Tests/Lembretes_Prints/Lembretes2.png}
\caption{Reminders Tests Execution Results - 2/5}
\label{fig:reminders-tests-2}
\end{figure}
\clearpage
...
\includegraphics[
  ...
  height=1\textheight,
  keepaspectratio
]{images/Tests/Lembretes_Prints/Lembretes3.png}
\caption{Reminders Tests Execution Results - 3/5}
\label{fig:reminders-tests-3}
\end{figure}
\clearpage
...
\includegraphics[
  ...
  height=1\textheight,
  keepaspectratio
]{images/Tests/Lembretes_Prints/Lembretes4.png}
\caption{Reminders Tests Execution Results - 4/5}
\label{fig:reminders-tests-4}
\end{figure}
\clearpage
...
\includegraphics[
  ...
  height=1\textheight,
  keepaspectratio
]{images/Tests/Lembretes_Prints/Lembrete5.png}
\caption{Reminders Tests Execution Results - 5/5}
\label{fig:reminders-tests-5}
\end{figure}
\clearpage
